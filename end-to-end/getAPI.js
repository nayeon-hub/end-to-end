...
function comAttack() {
  fetch(
    `https://opendict.korean.go.kr/api/search?certkey_no=2849&key=C29443A68DF102A4384A97D701358D4A&target_type=search&part=word&q=${nextAttack}&sort=popular&start=${start}&num=10&advanced=y&target=1&method=start&type1=word&pos=1&letter_s=2&letter_e=4&type3=general`
  )
    .then(function (res) {
      return res.text();
    })
